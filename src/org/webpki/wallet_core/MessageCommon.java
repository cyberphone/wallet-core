...
public class MessageCommon {
    ...
    public static final CBORInt PLATFORM_DATA_LBL      = new CBORInt(4);   
    public static final CBORInt WALLET_DATA_LBL        = new CBORInt(5);
    public static final CBORInt LOCATION_LBL           = new CBORInt(6);
